...
class BaseModel():
    ...
    def validation(self, dataloader, current_iter, tb_logger, save_img=False, rgb2bgr=True, w=None):
        """Validation function.
        ...
        """
        if self.opt['dist']:
            self.dist_validation(dataloader, current_iter, tb_logger, save_img, rgb2bgr=rgb2bgr, w=w)
        else:
            return self.nondist_validation(dataloader, current_iter, tb_logger, save_img, rgb2bgr=rgb2bgr, w=w)
